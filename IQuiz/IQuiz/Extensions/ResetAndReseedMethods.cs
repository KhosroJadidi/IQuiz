...
namespace IQuiz.Extensions
{
    public static class ResetAndReseedMethods
    {
        ...
        public static void ReseedDatabase(this ApplicationDbContext applicationDbContext)
        {
            var user = new User
            {
            ...
            var connectionString= "Server=localhost;Database=IQuiz_Db;Trusted_Connection=True;MultipleActiveResultSets=true";
            var query = @"USE [IQuiz_Db]
